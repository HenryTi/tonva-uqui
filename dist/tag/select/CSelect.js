...
var CSelect = /** @class */ (function (_super) {
    ...
    function CSelect(cIDTagList, itemTags, midTag, res) {
        ...
        _this.onTagSelectChanged = function (tag, selected) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.cIDTagList.onTagSelectChanged(this.itemTags, tag, selected)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    CSelect.prototype.internalStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.openVPage(VSelect_1.VSelect);
                return [2 /*return*/];
            });
        });
    };
    CSelect.prototype.onItemClick = function (item) {
        return; //this.props.onItemClick(item);
    };
    CSelect.prototype.renderRight = function () {
        return null;
    };
    return CSelect;
}(tonva_react_1.Controller));
exports.CSelect = CSelect;
//# sourceMappingURL=CSelect.js.map