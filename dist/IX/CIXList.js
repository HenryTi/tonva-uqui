...
exports.MidIXList = exports.CIXList = void 0;
...
var CIXList = /** @class */ (function (_super) {
    ...
    CIXList.prototype.update = function (item) {
        this.midIXList.update(item);
    };
    return CIXList;
}(list_1.CList));
exports.CIXList = CIXList;
var MidIXList = /** @class */ (function (_super) {
    ...
    MidIXList.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.IX.loadSchema()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    MidIXList.prototype.update = function (item) {
        var _this = this;
...
exports.MidIXList = MidIXList;
//# sourceMappingURL=CIXList.js.map