...
exports.CIX = exports.MidIX = void 0;
var tonva_react_1 = require("tonva-react");
var base_1 = require("../base");
var CIXList_1 = require("./CIXList");
var MidIX = /** @class */ (function (_super) {
    __extends(MidIX, _super);
    function MidIX(uq, IX, ID, id, res) {
...
var CIX = /** @class */ (function (_super) {
    ...
    CIX.prototype.internalStart = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, uq, IX, ID, id, midIXList, idList;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        idList = new CIXList_1.CIXList(midIXList);
