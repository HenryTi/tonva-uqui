...
var CRoleAdmin = /** @class */ (function (_super) {
    ...
    function CRoleAdmin(res, uq, myRolesChanged, roleCaptionMap) {
        ...
        _this.ixUserBind = function (user, ixName) { return __awaiter(_this, void 0, void 0, function () {
            var IX, id2Name, ID, midIX, cIXEdit;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        IX = this.uq.$.getIX(ixName);
                        return [4 /*yield*/, IX.loadSchema()];
                    case 1:
                        _a.sent();
                        id2Name = IX.schema.id2Name;
                        ID = this.uq.$.getID(id2Name);
                        midIX = new IX_1.MidIX(this.uq, IX, ID, user);
                        cIXEdit = new IX_1.CIXEdit(midIX);
                        return [4 /*yield*/, cIXEdit.start()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        _this.uq = uq;
        var uqMan = uq.$;
        _this.uqApi = uqMan.uqApi;
        _this.allRoles = uqMan.allRoles;
        if (!_this.allRoles || _this.allRoles.length === 0) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        mobx_1.runInAction(function () {
                            var r0 = allUserRoles.shift();
                            var roles = r0.roles;
                            if (roles) {
                                _this.ixOfUsers = roles.split('|');
                            }
                            var arr = _this.allRoles.map(function (v) { return "|" + v + "|"; });
                            ...
                            _this.userRoles = [];
                            var meId = _this.user.id;
                            for (var _i = 0, allUserRoles_1 = allUserRoles; _i < allUserRoles_1.length; _i++) {
                                var ur = allUserRoles_1[_i];
                                var user = ur.user, roles_1 = ur.roles;
                                var item = ur;
                                item.roles = rolesBool(roles_1);
                                if (user === meId)
                                    _this.meRoles = item;
                                else
                                    _this.userRoles.push(item);
                            }
                        });
    ...
    CRoleAdmin.prototype.fireMyRolesChanged = function (userRole, newRoles) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        this.fireMyRolesChanged(userRole, this.allRoles.map(function (v) { return false; }));
                        return [2 /*return*/];
                }
            });
        });
