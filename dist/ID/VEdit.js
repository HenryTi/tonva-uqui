...
var VEdit = /** @class */ (function (_super) {
    ...
    VEdit.prototype.content = function () {
        ...
        return jsx_runtime_1.jsx("div", __assign({ className: "p-3" }, { children: jsx_runtime_1.jsx(tonva_react_1.Form, { fieldLabelSize: 2, formData: item, schema: mid.itemSchema, uiSchema: mid.uiSchema, onButtonClick: this.onSubmit }, void 0) }), void 0);
    };
    return VEdit;
}(tonva_react_1.VPage));
exports.VEdit = VEdit;
